...
CREATE TABLE `organization` (
  ...
  `parent_id` int(10) NOT NULL DEFAULT 0 COMMENT '父级组织ID',
  ...
  `leader_id` int(10) NOT NULL DEFAULT 0 COMMENT '负责人ID（预留扩展）',
...
```
#### 3️⃣ 行政区 ↔ 组织映射表（area_relation）

```sql
CREATE TABLE `area_relation` (
  `id` int(11) NOT NULL AUTO_INCREMENT COMMENT '主键ID',

  `area_id` int(11) NOT NULL DEFAULT 0 COMMENT '行政区ID',
